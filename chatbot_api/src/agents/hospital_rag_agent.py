...
review_tool = reviews_vector_chain.as_tool(name="Experiences",
...
availability_tool = StructuredTool.from_function(name="Availability",
...
agent_tools = [ review_tool, graph_tool, waits_tool, availability_tool]
